...
commander_1.default.Command.prototype.withNetworkTimeoutOption = function () {
    return this.option('--timeout <timeout>', `timeout in seconds for each transaction when using an http connection (defaults to ${Session_1.DEFAULT_TX_TIMEOUT} seconds)`).option('--blockTimeout <timeout>', `timeout in blocks for each transaction when using a websocket connection (defaults to ${Session_1.DEFAULT_TX_BLOCK_TIMEOUT} blocks)`);
};
