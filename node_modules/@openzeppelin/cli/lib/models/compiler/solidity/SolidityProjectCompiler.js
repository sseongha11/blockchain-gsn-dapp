...
class SolidityProjectCompiler {
    ...
    writeOutput() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const artifactsByName = lodash_groupby_1.default(this.compilerOutput, (artifact) => artifact.contractName);
            const repeatedArtifacts = Object.keys(lodash_pickby_1.default(artifactsByName, (artifacts) => artifacts.length > 1));
            ...
            const sortedArtifactsByLocal = lodash_sortby_1.default(this.compilerOutput, (artifact) => { var _a, _b; return _b = (_a = this.contracts.find(c => c.filePath === artifact.sourcePath)) === null || _a === void 0 ? void 0 : _a.dependency, (_b !== null && _b !== void 0 ? _b : ''); });
            const uniqueArtifacts = lodash_uniqby_1.default(sortedArtifactsByLocal, (artifact) => artifact.contractName);
