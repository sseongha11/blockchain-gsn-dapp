...
export declare function parseArg(input: string | string[], { type, components }: MethodArgType): any;
 ...
 */
export declare function parseArray(input: string, open?: string, close?: string): (string | string[])[];
