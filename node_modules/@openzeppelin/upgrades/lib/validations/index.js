...
function newValidationErrors(validations, existingValidations = {}) {
    return {
        ...
        importsVanillaContracts: lodash_difference_1.default(validations.importsVanillaContracts, existingValidations.importsVanillaContracts),
    };
}
...
function validationPasses(validations) {
    return (lodash_every_1.default(validations.storageDiff, diff => diff.action === 'append') &&
        ...
        lodash_isempty_1.default(validations.importsVanillaContracts));
}
...
function tryGetUninitializedBaseContracts(contract) {
    try {
        const pipeline = [contracts => lodash_values_1.default(contracts), contracts => lodash_flatten_1.default(contracts), contracts => lodash_uniq_1.default(contracts)];
